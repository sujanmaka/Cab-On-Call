...
import com.maka.sujan.login.Map.Config;
import com.maka.sujan.login.Map.DriverActivity;
import com.maka.sujan.login.Map.MapsActivity;
import com.maka.sujan.login.Map.RequestHandler;
import com.maka.sujan.login.Map.UpdateLocation;
...
public class MapsActivityTryAgain extends FragmentActivity implements
        OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_maps_try_again);
  ...
  /*  private void getCurrentLocation() {
    ...
    public String makeURL (double sourcelat, double sourcelog, double destlat, double destlog ){
        ...
        urlString.append("&key=AIzaSyCm_kdhoHfSkQan0MqQPDPDs7IzlMTHsRU");
    ...
    public void drawPath(String  result) {
        ...
        Toast.makeText(this,String.valueOf(distance+" Meters and Estimated cost is Rs. " + (distance*50)/1000 ),Toast.LENGTH_LONG).show();
