...
public class LoginActivityD extends Activity {
    private static final String TAG = RegisterActivityD.class.getSimpleName();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (session.isLoggedIn()) {
            ...
            Intent intent = new Intent(LoginActivityD.this, MainActivityD.class);
    ...
    private void checkLogin(final String phone, final String password) {
        ...
        StringRequest strReq = new StringRequest(Method.POST,
                AppConfigD.URL_LOGIN, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (!error) {
                        ...
                        Intent intent = new Intent(LoginActivityD.this,
                                MainActivityD.class);
                        startActivity(intent);
                        finish();
                    } else {
