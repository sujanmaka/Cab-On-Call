...
public class RegisterActivityD extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (session.isLoggedIn()) {
            ...
            Intent intent = new Intent(RegisterActivityD.this,
                    MainActivityD.class);
    ...
    private void registerUser(final String name, final String phone,
        ...
        StringRequest strReq = new StringRequest(Method.POST,
                AppConfigD.URL_REGISTER, new Response.Listener<String>() {
